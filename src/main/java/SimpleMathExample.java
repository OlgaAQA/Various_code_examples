...
public class SimpleMathExample {
    public static void main(String[] args) {
        ...
        System.out.println("Пожалуйста введите число, подтверждая нажатием Enter");
        int d = sc.nextInt();
        ...
        System.out.println("Пожалуйста введите 3 различных числа, подтверждая нажатием Enter");
        int a = sc.nextInt();
        int b = sc.nextInt();
        int c = sc.nextInt();
